...
- **Next:** true OS-level input mode (Phase 4) and the remaining Phase 3 tooling (a unified action trace, `browser_assert`, YAML runner) — see PROPOSAL.md's roadmap.
