...
- **Next:** `mcp-task-delegation` (`browser_run_task` so an outer MCP host can delegate a sub-task to this same driver, screenshot vision-interpretation for vision-less outer models).
