...
- **Next:** Phase 5's originally-scoped hardening items are all now shipped or spiked (see PROPOSAL.md's roadmap) — no specific slice committed yet for what comes after.
