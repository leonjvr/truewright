...
| **3b-v — Tooling (assertions, runner)** | `browser_assert`, YAML runner + trace→YAML export | 1–2 wks | A recorded agent exploration replays green 20/20 against mocked network + deterministic clock/randomness; a 15-test suite runs headless in CI |
