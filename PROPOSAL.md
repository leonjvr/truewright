...
| **5 — Hardening (remaining)** | Cross-origin OOPIF (iframe) auto-attach, shadow-DOM edge corpus, weekly Chrome-beta CI, HTML trace viewer, streamable-HTTP polish, **BiDi spike** to validate the protocol trait | ongoing | — |
