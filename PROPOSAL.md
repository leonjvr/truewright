...
| **3b-vi — Tooling (YAML runner)** | YAML runner + trace→YAML export | 1 wk | A recorded agent exploration replays green 20/20 against mocked network + deterministic clock/randomness; a 15-test suite runs headless in CI |
