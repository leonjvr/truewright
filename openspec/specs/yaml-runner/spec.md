# yaml-runner Specification

## Purpose
The last piece of Phase 3 (Determinism): a way to define a test as a standalone, human-writable artifact independent of whatever conversation produced it, and to go the other direction too -- turning an already-captured action trace back into a runnable script, so "record once, replay as a checked-in test" is possible.
## Requirements
