...
Let an agent act on a page by ref — click, type, press, wait, screenshot — with a bounded-poll actionability gate and structured failure reasons instead of raw CDP errors.
