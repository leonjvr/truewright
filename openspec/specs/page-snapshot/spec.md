...
Give an LLM agent a token-efficient, ref-addressable text view of a page: an injected walker computes role/name/state for interactive and structural elements and the engine renders it as indented text.
